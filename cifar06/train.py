...
import h5py
import net8
netFile = os.path.join(imp.find_module("net8")[0]).read() # To save the current net structure in the hdf5 file
import Augument

#class scheduled_alpha_reduction(object):
...
#        print opt.epoch
#        if opt.epoch>=10 and opt.epoch%5 == 0:
#            opt.alpha /= 2
...
# Prepare dataset
    ...
    data_tr[:]  = h5f_tr["Original/data"].value
...
if __name__=="__main__":
    #CifarAnalysis("Output/1502.05700v2",batchsize = 500)
    #CifarAnalysis("Output/1502.05700v2_corrected",batchsize = 500)
    #CifarAnalysis("Output/1502.05700v2_corrected2",batchsize = 300)
    #CifarAnalysis("Output/1502.05700v2_net5",batchsize = 300)
    #CifarAnalysis("Output/1502.05700v2_net6",batchsize = 300)
    CifarAnalysis("Output/1502.05700v2_net8R3", Resume = "Output/1502.05700v2_net8R2/mlp_4.hdf5",batchsize = 250)
