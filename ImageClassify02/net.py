...
class ImageProcessNetwork(chainer.Chain):
    def __init__(self, F_unit):
        ...
        self.add_link("P3_3",L.Convolution2D(192,   192, 1, pad=1 ))
        ...
        self.add_link("BNL0" ,L.BatchNormalization(4032))
        self.add_link("L1"   ,L.Linear(4032, 200))
        self.add_link("BNL1" ,L.BatchNormalization(200))
        self.add_link("L2"   ,L.Linear(200, self.F_unit))
        return
